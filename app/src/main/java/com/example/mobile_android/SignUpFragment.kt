...
class SignUpFragment : Fragment() {
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putString(PASSWORD, passwordTextView?.text.toString())
        outState.putString(CONFIRM_PASSWORD, confirmPasswordTextView?.text.toString())
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.get(NAME) != null) {
                nameTextView?.setText(savedInstanceState.get(NAME).toString())
            }
            if (savedInstanceState.get(EMAIL) != null) {
                emailTextView?.setText(savedInstanceState.get(EMAIL).toString())
            }
            if (savedInstanceState.get(PASSWORD) != null) {
                passwordTextView?.setText(savedInstanceState.get(PASSWORD).toString())
            }
            if (savedInstanceState.get(CONFIRM_PASSWORD) != null) {
                confirmPasswordTextView?.setText(savedInstanceState.get(CONFIRM_PASSWORD).toString())
            }
        }
    }
